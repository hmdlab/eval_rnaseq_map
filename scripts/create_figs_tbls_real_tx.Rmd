...
paths_de_real_sub <-
  input_dirs_sub %>% lapply(utl$find_paths, h.de$PATTERNS$transcript) %>% unlist
...
paths_de_real_maqca <-
  input_dirs_maqca %>% lapply(utl$find_paths, h.de$PATTERNS$transcript) %>% unlist
...
paths_de_real_maqcb <-
  input_dirs_maqcb %>% lapply(utl$find_paths, h.de$PATTERNS$transcript) %>% unlist
...
paths_de_real_all_tx <-
  input_dirs_all %>% lapply(utl$find_paths, h.de$PATTERNS$transcript) %>% unlist
...
paths_de_real_all_gene <-
  input_dirs_all %>% lapply(utl$find_paths, h.de$PATTERNS$gene) %>% unlist
...
paths_de_sim_all_gene <-
  input_dirs_sim %>% lapply(utl$find_paths, h.de$PATTERNS$gene) %>% unlist
...
## 5. Number of DEs (with regular and mock comparison)
